...
class MaskedRCNN_ViT_L_FPN_Contexted(nn.Module):
    def __init__(self, device="cuda"):
        ...
        self.embed_dim, depth, num_heads, dp = 1024, 24, 16, 0.4
        self.window_block_indexes = list(range(0, 5)) + list(range(6, 11)) + list(range(12, 17)) + list(range(18, 23))
        num_classes = 80
    ...
    def load_weight(self, weight_pkl_path='./model_final_6146ed.pkl'):
    ...
    def forward_contexted(
        ...
        features = bottom_up_features[backbone.in_feature]  # (1, 1024, 64, 64)
        results = []
